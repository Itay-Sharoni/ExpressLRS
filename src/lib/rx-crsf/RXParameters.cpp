...
static selectionParameter luaSerialProtocol = {
    ...
    0, // value
  "CRSF;Inverted CRSF;SBUS;Inverted SBUS;SUMD;DJI RS Pro;HoTT Telemetry;MAVLink;DisplayPort;GPS;Scorpion;HB v4",
    STR_EMPTYSPACE
};
...
static selectionParameter luaSerial1Protocol = {
    ...
    0, // value
  "Off;CRSF;Inverted CRSF;SBUS;Inverted SBUS;SUMD;DJI RS Pro;HoTT Telemetry;Tramp;SmartAudio;DisplayPort;GPS;Scorpion;HB v4",
    STR_EMPTYSPACE
};
#endif
